    ...
    // Activate reveal animation when you scrolling
        ...
        $(function() {
            ...
            $("#signup-button").on('click', function() {
                var goolge_form_url = "https://docs.google.com/forms/d/1Lino6HNTEhNXKRvSDB5qJMcDdGhQAslylwK6_HiMsdI/viewform?entry.2005620554&entry.1045781291&entry.1166974658&entry.839337160=idealequations@dealyatra.com";
                var win = window.open(goolge_form_url, '_blank');
                win.focus();
